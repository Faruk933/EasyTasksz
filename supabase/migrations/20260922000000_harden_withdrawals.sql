...
-- Only trusted server-side Edge Functions may execute these functions.
...
REVOKE ALL ON FUNCTION public.transition_withdrawal(bigint, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.transition_withdrawal(bigint, text) FROM anon;
REVOKE ALL ON FUNCTION public.transition_withdrawal(bigint, text) FROM authenticated;
