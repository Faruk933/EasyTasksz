      ...
      {fields.map(([key, label, step]) => (
        <div key={key} style={{ background: "#1e293b", borderRadius: 14, padding: 16, marginBottom: 12 }}>
          ...
          <input
            ...
            style={{ width: "100%", boxSizing: "border-box", padding: 10, marginTop: 6, borderRadius: 8, border: "1px solid #334155", background: "#0f172a", color: "white" }}
          />
        </div>
      ))}
      <button onClick={save} disabled={saving} style={{ width: "100%", padding: 14, borderRadius: 12, border: "none", background: "#16a34a", color: "white", fontWeight: "bold" }}>
