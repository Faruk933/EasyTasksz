  ...
  const openBitcoTasks = () => {
    ...
    loginWithTelegram()
      .then((user) => {
        ...
        if (!opened) setError("BitcoTasks could not be opened. Please allow pop-ups and tap Open BitcoTasks again.");
      })
  ...
  return (
    <div style={{ minHeight: "100dvh", background: "#0b0f14", color: "#fff", display: "grid", placeItems: "center", padding: 24, textAlign: "center" }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <button type="button" onClick={openBitcoTasks} style={{ marginTop: 18, width: "100%", border: 0, borderRadius: 12, padding: "13px 18px", fontWeight: 700, fontSize: 15, cursor: "pointer" }}>Open BitcoTasks</button>
